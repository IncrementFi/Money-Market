...
oracleAddr = {}
oracleAddr["FlowToken"] = "0x01cf0e2f2f715450"
oracleAddr["FUSD"] = "0x179b6b1cb6755e31"
oracleAddr["BLT"] = "0xf3fcd2c1a78f5eee"
...
for poolName in setting.PoolNames+setting.FakePoolNames:
    ...
    cmd = 'flow transactions send cadence/transactions/Oracle/add_price_feed.cdc --arg Address:{0} --arg Address:{1} --signer emulator-account'.format(
        poolAddr, oracleAddr[poolName])
    print(cmd)
    os.system(cmd)
...
os.system('flow transactions send ./cadence/transactions/Comptroller/init_comptroller.cdc --arg Address:{0} --arg UFix64:{1} --signer emulator-account'.format("0xf8d6e0586b0a20c7", 0.5))
