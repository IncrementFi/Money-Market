...
pub contract interface OracleInterface {
    ...
    */
    ...
    pub resource PriceFeeder: PriceFeederPublic {
        ...
        // @Desc Set valid duration of price. If there is no update within the duration, the price will be expired.
    ...
    // @Desc Feeder related public interfaces opened on PriceOracle smart contract
    pub resource interface OraclePublicInterface_Feeder {
        ...
        // @Desc The oracle contract will get the PriceFeeder resource based on this path
