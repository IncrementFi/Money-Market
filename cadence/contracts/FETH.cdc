...
pub contract FETH: FungibleToken {
    ...
    // Total supply of fETH in existence
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance {
        ...
        destroy() {
            FETH.totalSupply = FETH.totalSupply - self.balance
        }
    }
    ...
    //
    pub fun createEmptyVault(): @FETH.Vault {
    ...
    pub resource Minter {
        ...
        //
        pub fun mintTokens(amount: UFix64): @FETH.Vault {
            pre {
                amount > 0.0: "Amount minted must be greater than zero"
            }
            FETH.totalSupply = FETH.totalSupply + amount
    ...
    pub resource Administrator {
        ...
        // transactions/fETH/minter/setup_fETH_minter.cdc
        // then the admin account running:
        // transactions/fETH/admin/deposit_fETH_minter.cdc
        //
    ...
    init() {
        self.AdminStoragePath = /storage/fETHAdmin
        self.MinterProxyPublicPath = /public/fETHMinterProxy
        self.MinterProxyStoragePath = /storage/fETHMinterProxy
