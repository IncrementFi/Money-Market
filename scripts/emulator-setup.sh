...
flow transactions send ./cadence/transactions/Comptroller/init_comptroller.cdc --arg Address:0xf3fcd2c1a78f5eee --signer emulator-account

#### Init Flow Pool
echo "---- Init flow lending pool"
flow transactions send ./cadence/transactions/Pool/init_flow_pool.cdc --arg Address:0xf8d6e0586b0a20c7 --arg Address:0xf8d6e0586b0a20c7 --signer emulator-flow-pool-deployer

### Comptroller add Flow Market
echo "---- Add Flow market"
